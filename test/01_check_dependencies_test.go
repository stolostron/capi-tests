...
// TestCheckDependencies_AzureAuthentication has been moved to Phase 04 (YAML generation).
// Credentials are now validated just-in-time before they are needed.

// TestCheckDependencies_AzureEnvironment has been moved to Phase 04 (YAML generation).
// Azure credentials are now validated just-in-time before they are needed.

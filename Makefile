...
# Deployment state remains separate from immutable identity but lives beside it.
DEPLOYMENT_STATE_FILE := $(dir $(abspath $(CAPI_TEST_CONTEXT_FILE))).deployment-state.json
